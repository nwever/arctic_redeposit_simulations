...
gawk -F, -v gt=7 -f extract_gt.awk ${f} > postprocess/${g}_gt.dat.mf
gawk -F, -v gt=8 -f extract_gt.awk ${f} > postprocess/${g}_gt.dat.if
gawk -F, -v gt=9 -f extract_gt.awk ${f} > postprocess/${g}_gt.dat.fcxr
